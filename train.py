...
nn.add_layer(Layer(n_neurons=X_train.shape[1]), weights_seed=w_seed, bias_seed=b_seed)
nn.add_layer(Layer(n_neurons=100, activation='tanh'), weights_seed=w_seed, bias_seed=b_seed)
nn.add_layer(Layer(n_neurons=y_train.shape[1], activation='softmax'), weights_seed=w_seed, bias_seed=b_seed)
